...
{
    public class ToggleArchivedFeedbackCommandHandler : IRequestHandler<ToggleArchivedFeedbackCommand, BaseResponse>
    {
        ...
        public async Task<BaseResponse> Handle(ToggleArchivedFeedbackCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                return new BaseResponse(0, "Only Company Employees are allowed to label feedbacks as archived.");
            }
            ...
            {
                return new BaseResponse(0, "Users are aloowed to olny manipulate feedbacks related to their company.");
            }
            if (_currentUser.UserDetail.Id != feedback.DirectedToEmployeeId)
            {
                return new BaseResponse(0, "Users are aloowed to olny manipulate feedbacks which directed to them.");
            }
