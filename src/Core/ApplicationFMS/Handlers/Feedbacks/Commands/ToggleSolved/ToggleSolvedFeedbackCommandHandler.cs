...
{
    public class ToggleSolvedFeedbackCommandHandler : IRequestHandler<ToggleSolvedFeedbackCommand, BaseResponse>
    {
        ...
        public async Task<BaseResponse> Handle(ToggleSolvedFeedbackCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                return new BaseResponse(0, "Only customers are allowed to label feedbacks as solved.");
            }
            ...
            {
                return new BaseResponse(0, "Users are only allowed to edit their own feedback.");
            }
